  ...
  return (
    ...
    <div className="hero min-h-full bg-base-100">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div>
          <h1 className="text-5xl font-bold">Showcase, Network, and Build New Skills</h1>
