...
const Footer = () => {
  ...
  return (
    <footer
      className="pt-20 pb-10 mx-auto text-center bg-base-300"
      style={{ clipPath: `ellipse(130% 100% at 51.45% 100%)` }}
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-customWith container mx-auto">
      ...
      <div className="flex justify-between items-center flex-col lg:flex-row pt-10 lg:pt-16 px-10 container mx-auto">
        <div>
          <span className="text-center py-5 mt-10">
            Copyright © {currentYear} - Job OnBoard || All Rights Reserved{" "}
          </span>
        </div>
